...
typedef RT_MODEL_Teach_Pendant_Task_S_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Teach_Pendant_Task_Space(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Teach_Pendant_Task_Space_initialize();
   extern void Teach_Pendant_Task_Space_terminate();
 */
...
static void rtExtModeSingleTaskUpload(RT_MODEL * S)
{
  {                                    /* Sample time: [0.0s, 0.0s] */
    rtExtModeUpload(0, Teach_Pendant_Task_Space_M->Timing.t[0]);
  }

  if (rtmIsMajorTimeStep(Teach_Pendant_Task_Space_M)) {/* Sample time: [0.001s, 0.0s] */
    rtExtModeUpload(1, (((Teach_Pendant_Task_Space_M->Timing.clockTick1+
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Teach_Pendant_Task_Space_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Teach_Pendant_Task_Space:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Teach_Pendant_Task_Space -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  Teach_Pendant_Task_Space_initialize();
  S = Teach_Pendant_Task_Space_M;
  ...
  Teach_Pendant_Task_Space_terminate();
